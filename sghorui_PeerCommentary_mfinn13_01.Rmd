---
title: "mfinn13_OriginalHomeworkCode_01"
...
Comment: I liked where you find difficulties while doing this Module and listed them down. Maybe I should also do that for future assignments!
...
ulysses2 <- ulysses[seq(from = 3, to = 22, by =3)] #interesting! Another way of doing this (which I used) is u[c(3,6,9,12,15,18,21)], but I see that your code is better for bigger datasets.
ulysses2
...
#starting matrix
m
x <- c(m[ , 2], m[, 3], m[, 6]) #another way: x<-m[,c(2,3,6)]
...
```
```{r}
#I think for the last part, this code is better suited.
...
#Add this also: names(Primates) <- list("Haplorhini", "Strepsirihini")
Primates
